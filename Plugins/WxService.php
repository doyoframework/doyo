...
class WxService
{
    ...
    private function access_token()
    {
        ...
        $key = $this->app_id . '_access_token';

        if (!$cache->exists($key)) {

            $url = $this->api_host . '/token?grant_type=client_credential&appid=' . $this->app_id . '&secret=' . $this->app_secret;
     ...
     * @throws \Exception\HTTPException
     */
    public function sendmsg_video($openid, $type, $media_id, $title = '', $description = '')
    {
        $url = $this->api_host . '/message/custom/send?access_token=' . $this->access_token();
     ...
     * @throws \Exception\HTTPException
     */
    public function sendmsg_music($openid, $type, $media_id, $music_title, $music_description, $hq_music_url, $thumb_media_id)
    {
        $url = $this->api_host . '/message/custom/send?access_token=' . $this->access_token();
        $data = array('touser' => $openid,
            'msgtype' => $type,
     ...
     * @throws \Exception\HTTPException
     */
    public function sendmsg_news($openid, $type, $media_id)
    {
        $url = $this->api_host . '/message/custom/send?access_token=' . $this->access_token();
     ...
     * @throws \Exception\HTTPException
     */
    public function sendmsg_card($openid, $type, $card_id)
    {
        $url = $this->api_host . '/message/custom/send?access_token=' . $this->access_token();
     ...
     * @throws \Exception\HTTPException
     */
    public function add_material($path, $type, $title = '', $introduction = '')
    {
     ...
     * @throws \Exception\HTTPException
     */
    public function add_temporary_material($path, $type, $title = '', $introduction = '')
    {
...
//    }
     ...
     * @throws \Exception\HTTPException
     */
    public function get_temporary_material($media_id)
    {
     ...
     * @throws \Exception\HTTPException
     */
    public function delete_material($media_id)
    {
     ...
     * @throws \Exception\HTTPException
     */
    public function updata_news($media_id, $index, $arr)
    {
